...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            @include('admin.layouts.includes.bread_cumb',['title'=>'User Management'])
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="username" readonly autocomplete="off" value="{{ $user->username }}" class="form-control" id="input-21" placeholder="Username" />
                                        @error('username')
                                            <div class="text-warning">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row">
                                    <label for="input-21" class="col-sm-2 col-form-label">Telegram Id</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="telegram_id" autocomplete="off" value="{{ $user->telegram_id }}" class="form-control" id="input-21" placeholder="telegram_id" />
                                        @error('telegram_id')
                                            <div class="text-warning">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row">
                                    <label for="input-21" class="col-sm-2 col-form-label">Telegram Name</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="telegram_name" autocomplete="off" value="{{ $user->telegram_name }}" class="form-control" id="input-21" placeholder="telegram_name" />
                                        @error('telegram_name')
                                            <div class="text-warning">{{ $message }}</div>
                                        @enderror
                                    </div>
