...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-theme bg-{{Auth::user()->admin_theme}}">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative" data-toggle="dropdown" href="javascript:void();">
                                <span class="user-profile">
                                    <img src="/{{ Auth::user()->photo }}" class="img-circle" alt="user avatar" />
                                </span>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li class="dropdown-item user-details">
                                    <a href="javaScript:void();">
                                        <div class="media">
                                            <div class="avatar">
                                                <img class="align-self-start mr-3" src="/{{ Auth::user()->photo }}" alt="user avatar" />
                                            </div>
                                            <div class="media-body">
                                                <h6 class="mt-2 user-title">{{ Helper::auth_full_name() }}</h6>
