<template>
    <div>
        <ul class="d-flex expense_btn">
            <li><a href="#" @click="fetch_admin_expenses(1)" class="btn btn-sm btn-outline-info active mx-2 text-dark">All <span>({{get_admin_expense_info.total_expense}})</span></a></li>
            <li><a href="#" @click.prevent="fetch_admin_deposit_expenses(1)" class="btn btn-sm btn-outline-info mx-2 text-dark">Deposit <span>({{get_admin_expense_info.total_deposit_expense}})</span></a></li>
            <li><a href="#" @click.prevent="fetch_admin_expense_expenses(1)" class="btn btn-sm btn-outline-secondary mx-2 text-dark">Expense <span>({{get_admin_expense_info.total_expense_expense}})</span></a></li>
        </ul>
